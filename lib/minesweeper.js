...
const checkSquare = (square) => {
  ...
  setTimeout(() => {
    if (sqId > 0 && !leftEdge) click(document.getElementById(sqId - 1));
    if (sqId > 7 && !rightEdge) click(document.getElementById(sqId + 1 - width));
    if (sqId > 7) click(document.getElementById(sqId - width));
    if (sqId > 8 && !leftEdge) click(document.getElementById(sqId - 1 - width));
    if (sqId < 63 && !rightEdge) click(document.getElementById(sqId + 1));
    if (sqId < 56 && !leftEdge) click(document.getElementById(sqId - 1 + width));
    if (sqId < 55 && !rightEdge) click(document.getElementById(sqId + 1 + width));
    if (sqId < 56) click(document.getElementById(sqId + width));
  }, 10);
};
